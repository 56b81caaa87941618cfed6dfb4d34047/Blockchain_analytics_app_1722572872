...
Vue.component("simple_header_component_1722572875", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-opacity-20 backdrop-blur-lg border border-pink-300 border-opacity-30 shadow-lg rounded-lg py-2.5 dark:bg-opacity-20 dark:backdrop-blur-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600">BlockScan - Blockchain Analytics Platform</span>
                </a>
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-pink-500 bg-purple-100 rounded-lg lg:bg-transparent lg:text-pink-500 lg:p-0 dark:text-pink-400" aria-current="page">Real-time Blockchain Monitoring</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-purple-600 border-b border-purple-100 hover:bg-purple-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-700 dark:hover:text-pink-400 lg:dark:hover:bg-transparent dark:border-purple-700">Customizable Data Visualizations</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-purple-600 border-b border-purple-100 hover:bg-purple-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-700 dark:hover:text-pink-400 lg:dark:hover:bg-transparent dark:border-purple-700">Advanced Transaction Analysis</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-purple-600 border-b border-purple-100 hover:bg-purple-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-700 dark:hover:text-pink-400 lg:dark:hover:bg-transparent dark:border-purple-700">Insightful On-Chain Metrics</a></li>
                    </ul>
                </div>
            </div>
        </nav>
